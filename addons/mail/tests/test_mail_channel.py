...
class TestChannelInternals(MailCommon):
    ...
    def test_channel_should_generate_correct_default_avatar(self):
        ...
        expceted_avatar_channel = (channel_avatar.replace('fill="#3b5cff"', f'fill="{bgcolor_channel}"')).encode()
        expected_avatar_group = (group_avatar.replace('fill="#3b5cff"', f'fill="{bgcolor_group}"')).encode()
